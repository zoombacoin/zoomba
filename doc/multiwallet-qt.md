...
In order to support loading of multiple wallets in zoomba-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zoomba.cpp.
...
Changes to zoomba.cpp
----------------------
zoomba.cpp is the entry point into zoomba-qt, and as such, will require some minor modifications to provide hooks for
