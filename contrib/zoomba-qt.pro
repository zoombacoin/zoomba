...
RESOURCES += src/qt/zoomba.qrc src/qt/zoomba_locale.qrc

TRANSLATIONS += src/qt/locale/zoomba_bg.ts \
                src/qt/locale/zoomba_de.ts \
                src/qt/locale/zoomba_en.ts \
                src/qt/locale/zoomba_es.ts \
                src/qt/locale/zoomba_fi.ts \
                src/qt/locale/zoomba_fr.ts \
                src/qt/locale/zoomba_it.ts \
                src/qt/locale/zoomba_ja.ts \
                src/qt/locale/zoomba_pl.ts \
                src/qt/locale/zoomba_pt.ts \
                src/qt/locale/zoomba_ru.ts \
                src/qt/locale/zoomba_sk.ts \
                src/qt/locale/zoomba_sv.ts \
                src/qt/locale/zoomba_vi.ts \
                src/qt/locale/zoomba_zh_CN.ts \
                src/qt/locale/zoomba_zh_TW.ts
