...
This means one can have an always-on zoombad instance running, and another local zoombad/zoomba-qt instance which connects to this node and receives blocks from it.
