Contributing to Zoomba Core
============================

The Zoomba Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zoomba Core project, and is not to be
confused with overall Zoomba Network Protocol consensus changes.

Whether a pull request is merged into Zoomba Core rests with the project merge
...
Patches that change Zoomba consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zoomba consensus, it must have been
...
The project leader is the release manager for each Zoomba Core release.
