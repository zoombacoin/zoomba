...
/** Utility functions used by the Zoomba Qt UI.
 */
namespace GUIUtil
{
...
// Render Zoomba addresses in monospace font
...
// Parse "zoomba:" URI into recipient object, return true on successful parsing
