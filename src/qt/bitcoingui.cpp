                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zoomba Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zoomba address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zoomba: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZBA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zoomba Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zoomba Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zoomba"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zoomba addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zoomba addresses"));
    ...
    openAction->setStatusTip(tr("Open a Zoomba: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zoomba Core help message to get a list with possible Zoomba command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zoomba Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zoomba network", "", count));
}
...
{
    QString strTitle = tr("Zoomba Core"); // default title
