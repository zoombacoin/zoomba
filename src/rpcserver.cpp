...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zoomba features */
        {"zoomba", "masternode", &masternode, true, true, false},
        {"zoomba", "listmasternodes", &listmasternodes, true, true, false},
        {"zoomba", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zoomba", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zoomba", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zoomba", "masternodedebug", &masternodedebug, true, true, false},
        {"zoomba", "startmasternode", &startmasternode, true, true, false},
        {"zoomba", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zoomba", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zoomba", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zoomba", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zoomba", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zoomba", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zoomba", "mnbudget", &mnbudget, true, true, false},
        {"zoomba", "preparebudget", &preparebudget, true, true, false},
        {"zoomba", "submitbudget", &submitbudget, true, true, false},
        {"zoomba", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zoomba", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zoomba", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zoomba", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zoomba", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zoomba", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zoomba", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zoomba", "checkbudgets", &checkbudgets, true, true, false},
        {"zoomba", "mnsync", &mnsync, true, true, false},
        {"zoomba", "spork", &spork, true, true, false},
        {"zoomba", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zoomba", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zoombad, or the -server option to zoomba-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zoomba-cli " + methodname + " " + args + "\n";
}
