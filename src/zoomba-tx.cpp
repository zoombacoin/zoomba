...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zoomba Core zoomba-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zoomba-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zoomba transaction") + "\n" +
                               "  zoomba-tx [options] -create [commands]   " + _("Create hex-encoded zoomba transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zoomba transaction
